...
export class Meme extends AbstractCommands {
    ...
    private async sendMeme(interaction: ChatInputCommandInteraction<CacheType>) {
        ...
        if (!meme) this.messageHelper.replyToInteraction(interaction, `her skjedde det ein feil. Hvis det skjer igjen tag @Bot-support`, { ephemeral: true, hasBeenDefered: false })
