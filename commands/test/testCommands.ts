...
import { ICollectableSeries, ItemRarity, IUserCollectable, LootboxQuality } from '../../interfaces/database/databaseInterface';
import { basicLootbox, eliteLootbox, LootboxCommands, premiumLootbox } from '../store/lootboxCommands';
...
export class TestCommands extends AbstractCommands {
    ...
    testCollectable: IUserCollectable = { name: 'crycatthumbsup', series: 'mazarini', rarity: ItemRarity.Common, inventory: { none: 0, silver: 0, gold: 1, diamond: 0 }}
    ...
    private async test(interaction: ChatInputCommandInteraction<CacheType> | ButtonInteraction<CacheType>) {
        ...
        const notes1 = '🎉 Patch Notes - Versjon 18.0.0 🎉'
