...
export class PatchNotes extends AbstractCommands {
    public static readonly currentVersion = '19.5.1'
    public static readonly currentPatchNotes = `* Loot chest setter nå knappene til disabled, eller enn å fjerne dem`
                                             + `\n * La til kvalitet på chest i embeden`
