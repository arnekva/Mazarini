...
export class PatchNotes extends AbstractCommands {
    public static readonly currentVersion = '20.1.1'
    public static readonly currentPatchNotes = `* Fikser forhåpentligvis en bug som hindret deg i å starte et more or less game <:kms:1275913334503247956>`
