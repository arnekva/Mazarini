...
export class PatchNotes extends AbstractCommands {
    public static readonly currentVersion = '19.1.0'
    public static readonly currentPatchNotes = `* Høie skal nå (i teorien) reagere med emojien på en loot reveal etter 30sek`
