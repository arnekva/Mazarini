...
export const GameValues: GameValuesType = {
    ...
    ccg: {
        ...
        defaultDeck: {
            ...
            valid: true,
            cards: [
                { id: 'arne', series: 'mazariniCCG', amount: 6 },
        ...
        botDeck: {
            easy: [
                {
                    // Scrappy Fighters: weak attacks, free chips, self-hurting gonk droids, minimal utility
                    name: 'easy',
                    active: true,
                    valid: true,
                    cards: [
                        { id: 'arne_caveman', series: 'mazariniCCG', amount: 3 },
                        { id: 'sw_battle_droid_n', series: 'swCCG', amount: 3 },
                        { id: 'geggiexcited', series: 'mazariniCCG', amount: 2 },
                        { id: 'shrekStare', series: 'mazariniCCG', amount: 2 },
                        { id: 'sw_gonk_droid_n', series: 'swCCG', amount: 2 },
                        { id: 'sniff', series: 'mazariniCCG', amount: 1 },
                        { id: 'turtle', series: 'mazariniCCG', amount: 2 },
                    ],
                },
                {
                    // Chaos Army: self-damage (arne, gonk), self-retard (jarjar), unreliable but funny
                    name: 'easy',
                    active: true,
                    valid: true,
                    cards: [
                        { id: 'arne', series: 'mazariniCCG', amount: 3 },
                        { id: 'sw_jarjar_n', series: 'swCCG', amount: 3 },
                        { id: 'sw_battle_droid_n', series: 'swCCG', amount: 2 },
                        { id: 'sw_gonk_droid_n', series: 'swCCG', amount: 2 },
                        { id: 'geggiexcited', series: 'mazariniCCG', amount: 2 },
                        { id: 'sw_darth_maul_n', series: 'swCCG', amount: 2 },
                        { id: 'catmygling', series: 'mazariniCCG', amount: 1 },
                    ],
                },
            ],
            medium: [
                {
                    // Balanced Strike: energy engine (kms2) + bleed/choke + reflect + sustain
                    name: 'medium',
                    active: true,
                    valid: true,
                    cards: [
                        { id: 'arne', series: 'mazariniCCG', amount: 2 },
                        { id: 'geggiexcited', series: 'mazariniCCG', amount: 2 },
                        { id: 'sw_darth_maul_n', series: 'swCCG', amount: 1 },
                        { id: 'kms2', series: 'mazariniCCG', amount: 2 },
                        { id: 'geggi_kill', series: 'mazariniCCG', amount: 1 },
                        { id: 'sw_han_solo_n', series: 'swCCG', amount: 1 },
                        { id: 'sw_mace_windu_n', series: 'swCCG', amount: 1 },
                        { id: 'the_chokester', series: 'mazariniCCG', amount: 1 },
                        { id: 'maggiscared', series: 'mazariniCCG', amount: 1 },
                ...
                {
                    // Status Control: debuffs (slow, retard, stun) + polse cleanse + energy economy
                    name: 'medium',
                    active: true,
                    valid: true,
                    cards: [
                        { id: 'shrekStare', series: 'mazariniCCG', amount: 2 },
                        { id: 'arne_caveman', series: 'mazariniCCG', amount: 2 },
                        { id: 'sw_battle_droid_n', series: 'swCCG', amount: 1 },
                        { id: 'kms2', series: 'mazariniCCG', amount: 2 },
                        { id: 'waiting', series: 'mazariniCCG', amount: 1 },
                        { id: 'are_you', series: 'mazariniCCG', amount: 1 },
                        { id: 'catmygling', series: 'mazariniCCG', amount: 1 },
                        { id: 'sw_general_grevious_n', series: 'swCCG', amount: 1 },
                        { id: 'sw_mace_windu_n', series: 'swCCG', amount: 1 },
                        { id: 'sw_yoda_n', series: 'swCCG', amount: 1 },
                        { id: 'kms_gun', series: 'mazariniCCG', amount: 1 },
                        { id: 'polse', series: 'mazariniCCG', amount: 1 },
                    ],
                },
            ],
            hard: [
                {
                    // Alpha Strike: kys nuke + energy engines + reflect/cleanse + bleed/steal + sustain
                    name: 'hard',
                    active: true,
                    valid: true,
                    cards: [
                        { id: 'kys', series: 'mazariniCCG', amount: 1 },
                        { id: 'kms_gun', series: 'mazariniCCG', amount: 1 },
                        { id: 'KEKW_gun', series: 'mazariniCCG', amount: 1 },
                        { id: 'polse', series: 'mazariniCCG', amount: 1 },
                        { id: 'sw_princess_leia_n', series: 'swCCG', amount: 1 },
                        { id: 'kms2', series: 'mazariniCCG', amount: 2 },
                        { id: 'geggi_kill', series: 'mazariniCCG', amount: 1 },
                        { id: 'yarrne', series: 'mazariniCCG', amount: 1 },
                        { id: 'sw_han_solo_n', series: 'swCCG', amount: 1 },
                        { id: 'sw_mace_windu_n', series: 'swCCG', amount: 1 },
                        { id: 'maggiscared', series: 'mazariniCCG', amount: 1 },
                        { id: 'geggiexcited', series: 'mazariniCCG', amount: 1 },
                        { id: 'arne', series: 'mazariniCCG', amount: 1 },
                        { id: 'sw_darth_maul_n', series: 'swCCG', amount: 1 },
                    ],
                },
                {
                    // Legendary Control: Luke heals+hits, copy trick, choke combo, energy ramp, debuffs
                    name: 'hard',
                    active: true,
                    valid: true,
                    cards: [
                        ...
                        { id: 'kms2', series: 'mazariniCCG', amount: 2 },
                        { id: 'choke_shield', series: 'mazariniCCG', amount: 1 },
                        { id: 'geggi_kill', series: 'mazariniCCG', amount: 1 },
                        { id: 'the_chokester', series: 'mazariniCCG', amount: 1 },
                        { id: 'are_you', series: 'mazariniCCG', amount: 1 },
                        { id: 'sw_han_solo_n', series: 'swCCG', amount: 1 },
                        { id: 'geggiexcited', series: 'mazariniCCG', amount: 1 },
                        { id: 'shrekStare', series: 'mazariniCCG', amount: 1 },
                        { id: 'sw_darth_maul_n', series: 'swCCG', amount: 1 },
                    ],
                },
            ],
