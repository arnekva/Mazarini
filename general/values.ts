    ...
    ccg: {
        ...
        deck: {
            ...
            rarityCaps: {
                rare: 15,
                epic: 15,
                legendary: 15, // Can have multiple different legendaries, but max 1 of each (enforced by validateMaxDuplicates)
            },
            typeCaps: {
                HEAL: 3,
                REFLECT: 1,
            ...
            easy: [
                {
                    ...
                    valid: true,
                    cards: [
                        { id: 'kms2', series: 'mazariniCCG', amount: 1 },
                        { id: 'shrekStare', series: 'mazariniCCG', amount: 3 },
                        { id: 'geggi_kill', series: 'mazariniCCG', amount: 3 },
                        { id: 'arne', series: 'mazariniCCG', amount: 2 },
                        { id: 'geggiexcited', series: 'mazariniCCG', amount: 2 },
                        { id: 'sw_han_solo_n', series: 'swCCG', amount: 2 },
                        { id: 'sw_mace_windu_n', series: 'swCCG', amount: 2 },
                    ],
                },
                {
                    // Lett #2
                    ...
                    cards: [
                        ...
                        { id: 'sw_padme_n', series: 'swCCG', amount: 1 },
                        ...
                        { id: 'arne_caveman', series: 'mazariniCCG', amount: 1 },
                        { id: 'geggi_kill', series: 'mazariniCCG', amount: 2 },
                        { id: 'turtle', series: 'mazariniCCG', amount: 1 },
                    ],
                },
            ],
            medium: [
                {
                    ...
                    cards: [
                        ...
                        { id: 'shrekStare', series: 'mazariniCCG', amount: 2 },
                        { id: 'maggiscared', series: 'mazariniCCG', amount: 5 },
                        { id: 'hoie', series: 'mazariniCCG', amount: 1 },
                        { id: 'sw_general_grevious_n', series: 'swCCG', amount: 2 },
                        { id: 'sw_mace_windu_n', series: 'swCCG', amount: 2 },
                ...
                },
                {
                    ...
                    cards: [
                        ...
                        { id: 'maggiscared', series: 'mazariniCCG', amount: 3 },
                        { id: 'geggi_kill', series: 'mazariniCCG', amount: 2 },
            ...
            hard: [
                {
                    ...
                    cards: [
                        ...
                        { id: 'pointerbrothers1', series: 'mazariniCCG', amount: 4 },
                        { id: 'hoie', series: 'mazariniCCG', amount: 1 },
                        { id: 'sw_luke_skywalker_n', series: 'swCCG', amount: 1 },
                        { id: 'are_you', series: 'mazariniCCG', amount: 1 },
                        { id: 'kms_gun', series: 'mazariniCCG', amount: 4 },
                        { id: 'sw_mace_windu_n', series: 'swCCG', amount: 2 },
                    ],
                },
                {
                    ...
                    cards: [
                        { id: 'kms2', series: 'mazariniCCG', amount: 1 },
                        { id: 'kms_gun', series: 'mazariniCCG', amount: 5 },
                        { id: 'sw_luke_skywalker_n', series: 'swCCG', amount: 1 },
                        { id: 'are_you', series: 'mazariniCCG', amount: 1 },
                        { id: 'pointerbrothers1', series: 'mazariniCCG', amount: 3 },
                        { id: 'sw_mace_windu_n', series: 'swCCG', amount: 3 },
                        { id: 'yarrne', series: 'mazariniCCG', amount: 1 },
                    ],
                },
            ],
