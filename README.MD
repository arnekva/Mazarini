...
Se [docs/copilot-agents-vscode.md](docs/copilot-agents-vscode.md) for en guide til hvordan du bruker GitHub Copilot coding agent (bakgrunnsagenter) og kobler det til VS Code.
