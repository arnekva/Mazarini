export namespace textArrays {
    ...
    export const bentHoieLinesAnswers = [
        ...
        'wtf, ja',
        'Rektigt',
        'dummaste eg har hørt',
        'henvise te advokaten min',
        'det ble neiii',
        'spør du meg spør eg mor te eivind',
        'det kan du faenmeg bare drida i',
        'løgnaste eg har hørt',
        'det e faktisk på tide',
        'hvis det e 39 tegn i denne setningen e svaret nei',
        'ja?',
        'stemme',
        'det e opp te deg',
    ]
